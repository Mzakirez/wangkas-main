                                ...
                                <tr wire:key="{{ $cashTransaction->id }}">
                                  ...
                                  <td class="text-center">
                                    @if ($cashTransaction->proof_image)
                                      @php
                  // PERBAIKAN: Pastikan menggunakan asset() dengan path yang benar
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body text-center bg-light">
            {{-- Informasi Detail --}}
            <div class="text-start mb-3 p-3 bg-white rounded border border-primary-subtle">
              <table class="table table-sm table-borderless mb-0">
                <tr>
                  <td style="width: 100px;" class="fw-bold">Siswa</td>
            ...
            <img id="previewProofImage" src="" class="img-fluid rounded shadow" alt="Preview Bukti Pembayaran"
              style="max-height: 60vh; object-fit: contain; min-height: 200px; background: #ddd;">

            <div class="mt-2 text-muted small fst-italic" id="fileNameInfo"></div>
          </div>
          <div class="modal-footer">
...
@script
<script>
  // Definisikan fungsi ke window agar bisa diakses global (tahan re-render Livewire)
  window.showProofPreview = function (imageSrc, studentId, studentName, paymentDate) {
    // 1. Format Nama File untuk Download (Ganti spasi dengan underscore, hapus karakter aneh)
    ...
    img.onload = function () {
      ...
      downloadLink.download = fileName; // Atribut HTML5 untuk memaksa nama file
