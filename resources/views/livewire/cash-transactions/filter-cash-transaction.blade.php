<div>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($this->statistics['studentsNotPaidCount'] > 0)
                        <div class="card mb-3">
                            <div class="card-body">
                                <button type="button" class="btn btn-primary btn-block btn-xl font-bold"
                                    data-bs-toggle="modal" data-bs-target="#notPaidModal">
                                                ...
                                                <div class="card border rounded">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text text-muted">
                                                            {{ $student->identification_number }}</p>
                                                        <p class="card-text text-muted">
                                                        ...
                                                        <span
                                                            class="badge bg-light-{{ $student->gender == 1 ? 'primary' : 'danger' }}">
                                                            <i
                                                                class="bi bi-gender-{{ $student->gender == 1 ? 'male' : 'female' }}"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="form-group has-icon-left">
                            <div class="position-relative">
                                <input wire:model.live="query" type="text"
                                    class="form-control form-control shadow-sm rounded fw-bold"
                                        ...
                                        <td class="text-center">
                                            @if ($cashTransaction->proof_image)
                                                ...
                                                <button type="button" class="btn btn-link p-0 border-0"
                                                    onclick="window.showProofPreviewFilter(
        ...
        '{{ $cashTransaction->date_paid }}'
                                                    ...
                                                    <img src="{{ asset('uploads/' . $cashTransaction->proof_image) }}"
                                            ...
                                            @else
                                                ...
                                                <img src="{{ asset('images/no-image.png') }}" alt="Tidak ada bukti"
                            ...
                            <tfoot>
                                <tr role="row">
                                    <td colspan="4" class="fw-bold">Total
                                        {{ $selectedMonthName ?? 'Periode Dipilih' }}:</td>
                                    <td colspan="2">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <img id="previewProofImageFilter" src="" class="img-fluid rounded shadow"
                    alt="Preview Bukti Pembayaran" style="max-height: 60vh; object-fit: contain;">
