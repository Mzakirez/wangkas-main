            ...
            <div class="card card-body">
              <div class="row">
                ...
                <div class="col-sm-12 col-md-3">
                  <label for="school_program_id" class="form-label">Program:</label>
                  <select wire:model.live="filters.schoolProgramID" class="form-select" id="school_program_id">
...
$startIndex = ($students->currentPage() - 1) * $students->perPage() + 1;
              ...
              @forelse ($students as $index => $student)
                <tr wire:key="{{ $student->id }}">
                  ...
                  <td>
                    @if(isset($student->schoolProgram))
                      <span class="badge bg-info text-dark">
                        {{ $student->schoolProgram->name }}
                      </span>
                    @else
